    ...
    try {
        ...
        if (name === "accept_quest") {
            ...
            const txOptions = {
                ...
                functionArgs: [(0, transactions_1.uintCV)(questId)],
            ...
            const broadcastResponse = await (0, transactions_1.broadcastTransaction)({ transaction });
            return {
                content: [{
                        type: "text",
        ...
        if (name === "submit_proof") {
            ...
            const txOptions = {
                ...
                functionArgs: [
                    (0, transactions_1.uintCV)(questId),
                    (0, transactions_1.bufferCV)(Buffer.from(proofHash, 'hex'))
                ],
                senderKey: SENDER_KEY,
        ...
        if (name === "check_reputation") {
            ...
            const result = await (0, transactions_1.fetchCallReadOnlyFunction)({
                ...
                functionArgs: [(0, transactions_1.contractPrincipalCV)(agentAddress, "agent")], // Assuming principal is passed
            ...
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify((0, transactions_1.cvToValue)(result))
                    }]
            };
        }
